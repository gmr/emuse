...
class Account(pydantic.BaseModel):
    ...
    salt: pydantic.SecretBytes = \
        pydantic.Field(default_factory=_generate_salt)
    ...
    @classmethod
    async def authenticate(cls, postgres: database.ConnectionType,
                           email: pydantic.EmailStr,
                           password: str) -> typing.Self | None:
    ...
    @classmethod
    async def get(cls, postgres: database.ConnectionType,
                  account_id: uuid.UUID) -> typing.Self | None:
